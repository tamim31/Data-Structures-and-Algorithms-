...
int main()
{
    ...
    for (int cycle = 1; cycle <= 15; cycle++)
    {
        ...
        fprintf(fn, "%d %lf\n", n, algo4time + bothtime);
    }

    char *comm[] = {"set title \"Time plot-minimum\"", "plot 'Algo-1.tmp' lt 7 lw 2 lc 1 w l", "replot 'Algo-2.tmp' lt 7 lw 2 lc 4 w l", "replot 'Algo-3.tmp' lt 7 lw 2 lc 2 w l", "replot 'Algo-4.tmp' lt 7 lw 2 lc 7 w l"};
